...
function Parser:processStatementTokens(parse_tree, token_list, idx, list_size, context)
    ...
    while idx <= list_size do
        ...
        elseif ttype == "R_BRACE" then
            ...
            dprint2(self.root)
            derror("Found '}' without previous matching '{' nor a ';' at index:", idx)
