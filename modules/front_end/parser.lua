...
function M:processBlockTokens(parse_tree, token_list, idx, list_size, context, context_end)
...
function M:processStatementTokens(parse_tree, token_list, idx, list_size, context)
    local syntax = self.syntax
...
function M:processHeadTokens(parse_tree, token_list, idx, list_size, context)
...
function M:dump(pfunc, parse_tree)
