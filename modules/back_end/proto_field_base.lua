...
setmetatable( DecoderBase, { __index = back_end.Base } ) -- inherit from Base
back_end:registerClass(nil, "DecoderBase", DecoderBase)
...
function DecoderBase.new(ttype, pfield, tag, name)
    local new_class = back_end.Base.new(ttype) -- the new instance
