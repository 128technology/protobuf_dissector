...
setmetatable( DoubleDecoder, { __index = back_end.DecoderBase } ) -- make it inherit from DecoderBase
back_end:registerClass("DOUBLE", "DoubleDecoder", DoubleDecoder)



function DoubleDecoder.new(pfield, tag, name)
    local new_class = decoder.DecoderBase.new("DOUBLE", pfield, tag, name)
