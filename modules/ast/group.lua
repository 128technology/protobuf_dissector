...
function GroupStatement.parse(st, namespace)
    ...
    assert(AstFactory.verifyTokenTTypes("GROUP", st, false, "GROUP", "IDENTIFIER", "EQUAL", "NUMBER", "BRACE_BLOCK"))
    ...
    return Identifier.new(st, 3), value, Syntax:convertTokenNumber(st[5])
end
