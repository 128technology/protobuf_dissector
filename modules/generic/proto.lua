...
GenericProto.wire_type_valstring = {
    [0] = "VARINT",
    [1] = "FIXED64",
    [2] = "LENGTH_DELIMITED",
    [3] = "START_GROUP",
...
GenericProto.pfields = {
    ...
    wire_type = ProtoField.uint8 ("protobuf.wire_type", "Wire Type", base.DEC, GenericProto.wire_type_valstring, 0x03, "Field wire type value"),
    length    = ProtoField.uint64("protobuf.length", "Length", base.DEC, nil, nil, "Field length"),
    value     = ProtoField.uint64("protobuf.value", "Value", base.DEC, nil, nil, "Unsigned value"),
    length_delimiter = ProtoField.uint64("protobuf.length_delimiter_value", "Length Delimiter Value", base.DEC, nil, nil, "Field length-delimited length value"),
...
GenericDecoder:addDecoder("FIXED32", Fixed32Decoder.new(GenericProto.pfields.FIXED32))
GenericDecoder:addDecoder("FIXED64", Fixed64Decoder.new(GenericProto.pfields.FIXED64))
GenericDecoder:addDecoder("VARINT", VarintDecoder.new(GenericProto.pfields.VARINT))
GenericDecoder:addDecoder("START_GROUP", GroupDecoder.new(GenericProto.pfields.GROUP))
GenericDecoder:addDecoder("LENGTH_DELIMITED", BytesDecoder.new(GenericProto.pfields.LENGTH_BYTES))


local packet_decoder = PacketDecoder.new(GenericProto.proto)

function GenericProto.proto.dissector(tvbuf, pktinfo, root)
    print("GenericProto dissector called")
